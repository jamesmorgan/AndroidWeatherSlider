...
@Deprecated
public class EnterLocationActivity_old extends Activity implements SimpleGestureListener {
	...
	public void onGetCurrentMyLocation(final View v) {
		...
		if (null != this.mBoundMyLocationService && this.mIsLocationServiceBound) {
			runOnUiThread(new Runnable() {
				@Override
				public void run() {
					EnterLocationActivity_old.this.mBoundMyLocationService.getLocation(EnterLocationActivity_old.this,
							EnterLocationActivity_old.this.locationResult);
				}
			});
		}
		else {
	...
	private final ServiceConnection mConnection = new ServiceConnection() {
		...
		public void onServiceConnected(final ComponentName className, final IBinder service) {
			...
			EnterLocationActivity_old.this.mBoundMyLocationService = ((GetMyLocationBindableService.LocalBinder) service).getService();
		}

		@Override
		public void onServiceDisconnected(final ComponentName className) {
			Logger.d(LOG_TAG, "Disconnected from gps service");
			EnterLocationActivity_old.this.mBoundMyLocationService = null;
			Toast.makeText(EnterLocationActivity_old.this, "Unable to locate you, please ensure you are connected to the network.",
